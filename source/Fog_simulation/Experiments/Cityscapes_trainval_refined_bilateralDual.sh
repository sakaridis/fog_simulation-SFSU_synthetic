...
VARIANT="dualRange_crossBilateral_filtering"
BETA="0.005"
OUTPUT_ROOT_DIR="/scratch_net/nowin/csakarid/Toyota-foggy/data/Cityscapes/temp" # Change to preferred directory for writing results of simulation.
IMAGES_PER_TASK="50"
